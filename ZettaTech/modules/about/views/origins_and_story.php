            ...
            <div class="portlet-body form">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?=($Language == 'english' ? 'active in' : '')?>" id="tab_english">
                        <?=form_open_multipart('about/origins_and_story/english', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="origins_and_story_english"  id="redactor_content_english" class="form-control"><?=$origins_and_story['english']?></textarea>
                                        </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade <?=($Language == 'italian' ? 'active in' : '')?>" id="tab_italian">
                        <?=form_open_multipart('about/origins_and_story/italian', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="origins_and_story_italian"  id="redactor_content_italian" class="form-control"><?=$origins_and_story['italian']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'spanish' ? 'active in' : '')?>" id="tab_spanish">
                        <?=form_open_multipart('about/origins_and_story/spanish', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="origins_and_story_spanish"  id="redactor_content_spanish" class="form-control"><?=$origins_and_story['spanish']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'german' ? 'active in' : '')?>" id="tab_german">
                        <?=form_open_multipart('about/origins_and_story/german', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="origins_and_story_german"  id="redactor_content_german" class="form-control"><?=$origins_and_story['german']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'french' ? 'active in' : '')?>" id="tab_french">
                        <?=form_open_multipart('about/origins_and_story/french', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="origins_and_story_french"  id="redactor_content_french" class="form-control"><?=$origins_and_story['french']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'russian' ? 'active in' : '')?>" id="tab_russian">
                        <?=form_open_multipart('about/origins_and_story/russian', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="origins_and_story_russian"  id="redactor_content_russian" class="form-control"><?=$origins_and_story['russian']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
