            ...
            <div class="portlet-body form">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?=($Language == 'english' ? 'active in' : '')?>" id="tab_english">
                        <?=form_open_multipart('refund_policy/edit/english', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="refund_policy_english"  id="redactor_content_english" class="form-control"><?=$refund_policy['english']?></textarea>
                                        </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade <?=($Language == 'italian' ? 'active in' : '')?>" id="tab_italian">
                        <?=form_open_multipart('refund_policy/edit/italian', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="refund_policy_italian"  id="redactor_content_italian" class="form-control"><?=$refund_policy['italian']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'spanish' ? 'active in' : '')?>" id="tab_spanish">
                        <?=form_open_multipart('refund_policy/edit/spanish', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="refund_policy_spanish"  id="redactor_content_spanish" class="form-control"><?=$refund_policy['spanish']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'german' ? 'active in' : '')?>" id="tab_german">
                        <?=form_open_multipart('refund_policy/edit/german', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="refund_policy_german"  id="redactor_content_german" class="form-control"><?=$refund_policy['german']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'french' ? 'active in' : '')?>" id="tab_french">
                        <?=form_open_multipart('refund_policy/edit/french', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="refund_policy_french"  id="redactor_content_french" class="form-control"><?=$refund_policy['french']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="tab-pane fade <?=($Language == 'russian' ? 'active in' : '')?>" id="tab_russian">
                        <?=form_open_multipart('refund_policy/edit/russian', array('class' => 'form-horizontal'))?>
                            <div class="form-body">
                                <div class="form-group">
                                        <div class="col-md-12">
                                            <textarea name="refund_policy_russian"  id="redactor_content_russian" class="form-control"><?=$refund_policy['russian']?></textarea>
                                        </div>
                                </div>
                            </div>
                            <div class="form-actions">
