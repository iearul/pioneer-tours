 ...
 */
$config['site_title']                 = "Pioneer Tours";        // Site Title, example.com
$config['admin_email']                = "booking@pioneertours.net";   // Admin Email, admin@example.com
 ...
 */
$config['remember_cookie_name'] = 'zettabytetechnologies';
$config['identity_cookie_name'] = 'zettabytetechnologies_value';
