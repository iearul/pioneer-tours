...
if (!defined('SecurionPay_ROOT')) {
    define('SecurionPay_ROOT', dirname(__FILE__) . '/');
    require(SecurionPay_ROOT . 'Connection/Connection.php');
    require(SecurionPay_ROOT . 'Connection/CurlConnection.php');
    require(SecurionPay_ROOT . 'Exception/SecurionPayException.php');
    require(SecurionPay_ROOT . 'Util/ObjectSerializer.php');
}
